...
export function buildResearchPrompt(
  ...
  return [
    ...
    "本地文件隔离：只能读取当前任务指定的 source_diary、source_idea、brief_path（存在时）和 PROCESSOR_DIR/research-tasks.json；只能写入这些指定来源、当前任务研究简报和 research-tasks.json。除此之外不得读取、列出、搜索、测试、创建、修改或删除任何本地文件。",
